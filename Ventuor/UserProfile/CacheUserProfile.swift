...
struct Address: Codable {
    ...
    // var userProfile: CacheUserProfile? = nil
...
final class CacheUserProfile {
    ...
    init(userKey: String, userName: String, fullname: String, countrycode: String, phone: String, email: String, profilePhoto: String, profilePhotoName: String, profilePhotoType: String, homeAddress: Address, workAddress: Address, roles: [String] = [String](), lastModified: String) {
        self.userKey = userKey
    ...
    func update(data: CacheUserProfile, homeAddress: Address) {
        self.userName = data.userName
        self.fullname = data.fullname
        self.countrycode = data.countrycode
        self.phone = data.phone
        ...
        self.workAddress = data.workAddress
    }
