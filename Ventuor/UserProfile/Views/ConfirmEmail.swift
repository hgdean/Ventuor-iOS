    ...
    var body: some View {
        VStack(spacing: 40) {
            VStack(spacing: 30) {
                ...
                Text("We sent you a verification to email: \(newEmail) When you recieve it, enter the 5 digit code from the email below.")
                    .font(.caption)
                    .padding(.leading, 20)
                    .frame(maxWidth: .infinity, alignment: .leading)
                
                TextField("Enter confirmation code", text: $emailConfirmationCode)
                    .font(.callout)
                    .padding(.leading, 18)
                    .padding(.trailing, 18)
            ...
            VStack(spacing: 12) {
                ...
                Button(
                    action: {
                        userProfileModel.emailConfirmationCode = emailConfirmationCode
                        userProfileModel.saveEmail()
                        isPresented = false
                    },
                    label: {
                        HStack {
